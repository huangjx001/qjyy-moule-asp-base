...
@Data
@ApiModel("NC65 物料实体视图")
public class Nc65MaterialBriefVO {
	...
	@ApiModelProperty(value = "是否存在BOM（nc65_bom_hdr 是否存在 ml_id=productCode）", example = "true")
	private Boolean hasBom;

	@ApiModelProperty("计量单位列表（nc65_jydw，一对多）")
	private List<Nc65JydwVO> jydwList;
